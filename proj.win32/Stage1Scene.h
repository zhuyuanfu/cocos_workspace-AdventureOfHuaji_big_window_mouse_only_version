...
#include "D:\cocos_workspace\AdventureOfHuaji\cocos2d\cocos\base\CCEventKeyboard.h"
#include "cocos2d.h"
...
public:
	...
	//double current_speed_y_pix_by_frame = 1;
	//double max_speed_x_pix_by_frame = 2;
	//double max_speed_y_pix_by_frame = 10;

	//Sprite* groundArray[17] ;
	int leftBoundary = 20;
	int rightBoundary = 1020;
